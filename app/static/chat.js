document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (event) => {
        ...
        // KLUCZOWA ZMIANA: Zablokuj interfejs na czas przetwarzania
        setFormState(true);
        ...
        try {
            ...
            while (true) {
                ...
                modelResponseText += decoder.decode(value, { stream: true });
            ...
            // KLUCZOWA ZMIANA: Odblokuj interfejs po otrzymaniu odpowiedzi (nawet jeśli wystąpił błąd)
            setFormState(false);
        }
    });
